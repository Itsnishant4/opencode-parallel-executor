import { ParallelExecuteResult, StageExecutionResult, TaskResult } from "./types.js";

export class ResultFormatter {
  public static format(result: ParallelExecuteResult): string {
    ...
    lines.push(
      `### ${statusIcon} Parallel Execution Report${modeTag}\n`
    );
