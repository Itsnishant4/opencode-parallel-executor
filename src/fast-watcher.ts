...
export class FastWatcher {
  private static instance: FastWatcher;
  ...
  private maxFileSize = 100 * 1024; // 100 KB limit for auto pre-warming
  ...
  public static getInstance(rootDir?: string): FastWatcher {
  ...
  private async prewarmWorkspace(): Promise<void> {
  ...
  public getStatus(): { isWatching: boolean; prewarmedCount: number } {
    return {
