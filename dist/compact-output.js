...
export class OutputCompactor {
     ...
     */
    static compactCommand(command, stdout, stderr, exitCode) {
        ...
        if (/\b(tsc|typecheck|lint|eslint|biome|pyright|mypy)\b/.test(cmdLower)) {
            ...
            if (lines.length === 0)
                return "✓ Completed cleanly with 0 errors.";
        }
...
//# sourceMappingURL=compact-output.js.map